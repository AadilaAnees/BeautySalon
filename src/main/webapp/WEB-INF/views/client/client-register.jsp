...
<head>
    ...
    <title>Register - Elegant Beauty Salon</title>
    ...
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/register" method="post">
            ...
            <div class="registration-info">
                ...
                <ul>
                    <li>Easily book and manage your salon appointments</li>
                    <li>Receive notifications about appointment status</li>
                    <li>Access exclusive offers and promotions</li>
                    <li>View your appointment history and receipts</li>
                </ul>
            </div>
