...
<head>
    ...
    <title>Edit User - Elegant Beauty Salon</title>
        ...
        <div class="content-card">
            <div class="user-banner">
                ...
                <div class="user-info-header">
                    <h2>${user.username}</h2>
                    <p>User ID: #${user.id} • ${user.role == 'ADMIN' ? 'Administrator' : 'Client'}</p>
                </div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/admin/user/update" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="role-options">
                        <div class="role-option ${user.role == 'CLIENT' ? 'active' : ''}" onclick="selectRole('CLIENT')">
                            <div class="role-icon">👤</div>
                            <div class="role-name">Client</div>
                            <div class="role-description">Can book appointments and manage personal profile</div>
                        </div>
                        <div class="role-option ${user.role == 'ADMIN' ? 'active' : ''}" onclick="selectRole('ADMIN')">
                            <div class="role-icon">👑</div>
