...
<head>
    ...
    <title>Edit Service - Salon Booking System</title>
    ...
    <div class="main-content">
        <div class="header">
            <div class="header-title">
                <h1>Edit Service</h1>
                <p>Update service details and information</p>
            </div>
        ...
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/admin/service/update" method="post">
                <input type="hidden" name="id" value="${service.id}">

                <div class="form-group">
                    <label for="name"><i class="fas fa-tag"></i> Service Name</label>
                    <input type="text" id="name" name="name" value="${service.name}" required maxlength="50">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <input type="number" id="price" name="price" class="input-with-icon" step="0.01" min="0" value="${service.price}" required>
                    </div>
                    <span class="form-hint">Enter the price in USD (e.g. 49.99)</span>
                </div>

                <div class="form-group">
                    <label for="durationMinutes"><i class="fas fa-clock"></i> Duration</label>
                    <input type="number" id="durationMinutes" name="durationMinutes" min="1" value="${service.durationMinutes}" required>
                    <span class="form-hint">Enter the duration in minutes</span>
                </div>

                <div class="form-group">
                    <label for="description"><i class="fas fa-align-left"></i> Description</label>
                    <textarea id="description" name="description" required maxlength="1000">${service.description}</textarea>
                    <span class="form-hint">Maximum 1000 characters. Long text will wrap automatically.</span>
                </div>
